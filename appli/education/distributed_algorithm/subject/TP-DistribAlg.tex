...
%To save the file after having modified it, follow instructions to
%quit and then you will be prompted with the question whether you wish to save it
%(exit with \verb=Ctrl+x= and then \verb='Y'= and \verb=Enter= to save).\\
...
To save changes: \verb=Ctrl+o= and then press \verb=Enter= \\
To exit: \verb=Ctrl+x=
%After editing, exit with \verb=Ctrl+x= and  press \verb='Y'= and \verb=Enter= to save.\\
...
You will be implementing the `RandSync-Bcast' clock-synchronization protocol %introduced in
